            ...
            <div class="form-field-group">
                <div class="form-field">
                    ...
                    <input class="input-box" type="date" id="birth-date" name="birth-date" min="1900-01-01"
                        value="<?php echo isset($birthDate) ? $birthDate : "" ?>" required>
                </div>
                <div class="form-field">
                    <label for="sex">Sex<span class="required">*</span></label>
                    <select class="input-box" id="sex" name="sex" required>
                        <option <?php echo isset($sex) && $sex == 'M' ? 'selected="selected"' : ''; ?> value="M">Male
                        </option>
                        <option <?php echo isset($sex) && $sex == 'F' ? 'selected="selected"' : ''; ?> value="F">Female
                        </option>
                        <option <?php echo isset($sex) && $sex == 'N' ? 'selected="selected"' : ''; ?> value="N">Not
                            declared</option>
                    </select>
                </div>
                <div class="form-field">
            ...
            <div class="form-field-group">
                <div class="form-field">
                    ...
                    <input class="input-box" type="text" id="address-line-2" name="address-line-2" maxlength="100"
                        value="<?php echo isset($addressLine2) ? $addressLine2 : "" ?>">
                </div>
                <div class="form-field">
                    ...
                    <input class="input-box" type="text" id="postal-code" name="postal-code" maxlength="20"
                        value="<?php echo isset($postalCode) ? $postalCode : "" ?>" required>
                </div>
            </div>
            <div class="form-field-group">
                <div class="form-field">
                    ...
                    <select class="input-box" id="country" name="country" required>
                        <option <?php echo isset($country) && $country == 'Canada' ? 'selected="selected"' : ''; ?>
                ...
                <div class="form-field">
                    ...
                    <select class="input-box" id="province" name="province" required>
                        <option <?php echo isset($province) && $province == 'Alberta' ? 'selected="selected"' : ''; ?>
                        ...
                        <option <?php echo isset($province) && $province == 'Manitoba' ? 'selected="selected"' : ''; ?>
                        ...
                        <option <?php echo isset($province) && $province == 'Newfoundland and Labrador' ? 'selected="selected"' : ''; ?> value="Newfoundland and Labrador">Newfoundland and Labrador
                        </option>
                        <option <?php echo isset($province) && $province == 'Nova Scotia' ? 'selected="selected"' : ''; ?>
                            value="Nova Scotia">Nova Scotia</option>
                        <option <?php echo isset($province) && $province == 'Ontario' ? 'selected="selected"' : ''; ?>
                        ...
                        <option <?php echo isset($province) && $province == 'Quebec' ? 'selected="selected"' : ''; ?>
                ...
                <div class="form-field">
                    ...
                    <input class="input-box" type="text" id="city" name="city"
                        value="<?php echo isset($city) ? $city : "" ?>" required>
                </div>
            </div>
            <div class="form-field-group">
                <div class="form-field">
                ...
                <div class="form-field">
                    ...
                    <input class="input-box" type="password" id="confirm-password" name="confirm-password"
        ...
        document.getElementById('profile-picture').addEventListener('change', function (event) {
            ...
            if (file) {
                ...
                if (file.size > maxSize) {
                    Swal.fire({
                        title: 'Error!',
                        text: 'The image is too large. Maximum allowed size is 5 MB.',
                        icon: 'error',
                        confirmButtonText: 'OK',
                        confirmButtonColor: "#3c8ae4"
                    })
